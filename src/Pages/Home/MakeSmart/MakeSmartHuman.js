...
const MakeSmartHuman = () => {
  return (
    ...
    >
      <div className="hero p-10 text-white my-6 ">
        <div className="hero-content flex-col lg:flex-row-reverse ">
          <img
            src={Shope}
            className=" rounded-lg lg:w-1/2 shadow-2xl hover:scale-110 transition duration-300 ease-in-out"
            alt=""
          />
          <div>
            ...
            {/* <span className="py-6">
              <Typewriter
                words={[
                  "An My-shop is an online business that sells a variety of goods and services. My-shops are",
            ...
            <p>
              An My-shop is an online business that sells a variety of goods and
              services. My-shops are", "business-to-consumer oriented. They are
              just like a retail store but instead of having a physical
              location, its location is on the internet.", "location, its
              location is on the internet.
            </p>

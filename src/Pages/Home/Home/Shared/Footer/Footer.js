                    ...
                    <div className="grid grid-cols-2 text-sm gap-x-3 text-white gap-y-8 lg:w-2/3 sm:grid-cols-4">
                        ...
                        <div className="space-y-3">
                            ...
                            <div className="flex justify-start space-x-3">
                                <a rel="noopener noreferrer" href="https://www.linkedin.com/in/md-rifat-miah-48555b257/" title="Instagram" className="flex items-center p-1">
                                    <AiFillLinkedin className='text-4xl' />
                                </a>
                                <a rel="noopener noreferrer" href="https://github.com/tanvirrifat1" title="Twitter" className="flex items-center p-1">
                                    <FaGithubSquare className='text-4xl' />
                                </a>
                                <a rel="noopener noreferrer" href="https://twitter.com/RifatKh77041896" title="Facebook" className="flex items-center p-1">

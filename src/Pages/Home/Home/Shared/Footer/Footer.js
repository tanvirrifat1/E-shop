...
const Footer = () => {
    return (
        <div
            ...
            }} className="footer p-10 bg-base-200 text-base-content text-white rounded-xl">
                <div>
            ...
            <footer style={{
                backgroundColor: '#16a085',
            }} className="footer text-white px-10 py-4 border-t bg-base-200 text-base-content border-base-300">

...
const Navbar = () => {
  ...
  const menuItmes = (
    <>
      ...
      <li className="font-bold text-[18px]  ">
        <Link to="/message">Total Order Summary</Link>
      </li>
      ...
      {user?.displayName ? (
        <p className="py-4 font-semibold text-[18px] text-purple-600 mr-2">
    ...
    <div>
      ...
      >
        ...
        <div className="navbar-center hidden lg:flex">
          <ul className="menu menu-horizontal px-1">{menuItmes}</ul>
        </div>
        <label

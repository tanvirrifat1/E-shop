...
const FeedBack = () => {
  ...
  return (
    <div
      style={{
        backgroundImage: `url("https://img.freepik.com/free-vector/review-rating-isometric-landing-page-banner_107791-1024.jpg?size=626&ext=jpg&uid=R83218281&ga=GA1.2.1908891225.1665030381&semt=sph")`,
    ...
    >
      <div>
        <div onClick={() => navigate(-1)}>
          <p className="text-white text-3xl p-4 my-4">
        ...
        <form onSubmit={handleReview} className="m-6 p-16 max-w-xl mx-auto">
          <div className=" gap-4">
            <div className="">
              ...
              <input
                ...
                className=" w-full p-3 bg-transparent border-2 border-base-300 rounded-2xl text-white  "
              />
            </div>
            <div className="">
          ...
          <div>
            ...
            <textarea
              name="description"
              className="w-full p-6 bg-transparent border-2 border-base-300 rounded-2xl text-white "
        ...
        {feedbacks &&
          feedbacks.map((feedback) => {
            ...
            return (
              <div
                key={_id}
                className="max-w-md p-8 sm:flex shadow-2xl sm:space-x-6 text-white"
              >
                <div className="flex-shrink-0 w-full mb-6 h-44 sm:h-32 sm:w-32 sm:mb-0">
                  <img
                    src={image}
                    alt=""
                    className="max-w-xs transition duration-300 ease-in-out hover:scale-110 object-cover object-center w-full h-full rounded dark:bg-gray-500"
                  />
                </div>
                  ...
                  <div className="space-y-1">
                    ...
                    <span className="flex items-center mt-2 space-x-2">
                      ...
                      <marquee behavior="" direction="10">
                        <span className="w-full p-3 bg-transparent border-2 border-base-300 rounded-2xl text-white  ">
                          {description}
                        </span>
                      </marquee>
                    </span>

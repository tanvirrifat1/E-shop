  ...
  return (
    <div>
      ...
      <form
        ...
        className="space-y-6 ng-untouched ng-pristine ng-valid p-6"
      >
        <div className="space-y-4">
          ...
          <div className="flex md:flex-row lg:flex-row flex-col gap-3">
            <div className="form-control w-full md:w-6/12 lg:w-6/12">
              ...
              <select
                defaultValue={""}
                className="w-full px-3 py-3 border rounded-md border-gray-900 focus:outline-green-500 bg-blue-200 text-gray-900"
                {...register("category", {
